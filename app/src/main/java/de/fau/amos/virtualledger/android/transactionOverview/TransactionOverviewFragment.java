 ...
 * {@link TransactionOverviewFragment.OnFragmentInteractionListener} interface
...
public class TransactionOverviewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView transactionSumText = (TextView) view.findViewById(R.id.transaction_sum_text);

        System.out.println(transactionSumText.getText());//TODO
        transactionSumText.setText("Hier kommt die Summe hin");//#Baustelle
        System.out.println(transactionSumText.getText());
        System.out.println("HHHHHHHHHHHHHHAAAAAAAAAAAAAAALLLLLLLLLLLLLOOOOOOOOOOO");


        ListView transactionList = (ListView) view.findViewById(R.id.transaction_list);
