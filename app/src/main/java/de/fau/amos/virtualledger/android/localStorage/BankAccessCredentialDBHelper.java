...
class BankAccessCredentialDBHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE = "CREATE TABLE " + BankAccessCredentialDBConstants.TABLE_NAME + " (_id INTEGER PRIMARY KEY, " + BankAccessCredentialDBConstants.COLUMN_NAME_USER + " TEXT, " + BankAccessCredentialDBConstants.COLUMN_NAME_PIN + " TEXT, " + BankAccessCredentialDBConstants.COLUMN_NAME_ACCESSID + " TEXT, " + BankAccessCredentialDBConstants.COLUMN_NAME_ACCOUNTID + " TEXT, "  + BankAccessCredentialDBConstants.COLUMN_NAME_ACCESS_NAME + " TEXT, "  + BankAccessCredentialDBConstants.COLUMN_NAME_ACCOUNT_NAME + " TEXT)";
